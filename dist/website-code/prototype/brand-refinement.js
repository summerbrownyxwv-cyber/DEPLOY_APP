  ...
  home() {
    return `<div class="home-shell xh-home">
      <section class="xh-opening" data-immersive-hero aria-labelledby="home-title">
        <img class="xh-opening-image" src="../../assets/figma-stores-v1/imgE4A99442.webp" width="4096" height="2731" fetchpriority="high" alt="寻艾黑金店的山水壁画与接待空间">
      ...
      <section class="xh-origin xh-section" aria-labelledby="xh-origin-title"><div class="xh-origin-heading"><p class="xh-label">寻艾是谁</p><h2 id="xh-origin-title">一株艾草，<br>一种生活。</h2><a class="xh-link route-link" href="#/brand/about">了解品牌<span aria-hidden="true">↗</span></a></div><div class="xh-origin-story"><figure><img src="../../assets/figma-brand-v2/imgDsc13822.webp" width="4096" height="2731" loading="lazy" alt="蕲春艾草种植基地"></figure><div class="xh-origin-caption"><span>从蕲春出发</span><p>寻艾是「东元集团」旗下终端品牌。以线下艾灸馆为基础业态，将艾草、产品与服务带入日常。</p></div></div></section>
      <section class="xh-system xh-section" aria-labelledby="xh-system-title"><header class="xh-section-head"><h2 id="xh-system-title">从艾草到服务</h2><a class="xh-link route-link" href="#/brand/about/business">新商业范式<span aria-hidden="true">↗</span></a></header><div class="xh-industry-grid">${[['imgDsc13822.webp','原材品质','蕲春艾草'],['research-replacement.webp','研发生产','务实研发与生产'],['imgRectangle3.webp','终端服务','运营服务与连锁']].map(([img,title,caption])=>`<a class="xh-industry route-link" href="#/brand/about/business"><figure><img src="../../assets/figma-brand-v2/${img}" width="1920" height="1280" loading="lazy" alt="${title}"></figure><div><h3>${title}</h3><span aria-hidden="true">↗</span></div><p>${caption}</p></a>`).join('')}</div></section>
      <section class="xh-sanctuary" aria-labelledby="xh-stores-title"><div class="xh-sanctuary-heading"><p>寻艾艾灸馆</p><h2 id="xh-stores-title">留一刻，<br>给自己。</h2></div><figure class="xh-sanctuary-image"><img src="../../assets/figma-stores-v2/comp-imgRectangle5.webp" width="678" height="878" loading="lazy" alt="寻艾门店温润的空间与服务细节"></figure><div class="xh-sanctuary-links"><p>空间承载服务，细节传递关怀。</p><a class="xh-row route-link" href="#/stores/black-gold/detail"><span>黑金店</span><span aria-hidden="true">↗</span></a><a class="xh-row route-link" href="#/stores/standard/detail"><span>标准店</span><span aria-hidden="true">↗</span></a><a class="xh-row route-link" href="#/stores/services"><span>服务卡项</span><span aria-hidden="true">↗</span></a></div></section>
